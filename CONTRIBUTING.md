...
1. Make sure that the contribution you want to make is explained or detailed in a GitHub issue! Find an [existing issue](https://github.com/jayapatidar123/gitprofile/issues) or [open a new one](https://github.com/jayapatidar123/gitprofile/issues/new).
2. Once done, [fork the repository](https://github.com/jayapatidar123/gitprofile/fork) in your own GitHub account.
